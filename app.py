...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QtCore.QRect(240, 630, 241, 41))
        ...
        self.generateButton.setGeometry(QtCore.QRect(530, 630, 241, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "String manipulation"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Lists"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Dictionaries"))
        self.comboBox.setItemText(3, _translate("MainWindow", "Tuples"))
        self.comboBox.setItemText(4, _translate("MainWindow", "Sets"))
        self.comboBox.setItemText(5, _translate("MainWindow", "Indexing and Slicing"))
        self.comboBox.setItemText(6, _translate("MainWindow", "Mutable and Imutable types"))
        self.comboBox.setItemText(7, _translate("MainWindow", "Data types"))
        self.comboBox.setItemText(8, _translate("MainWindow", "Methods of types"))
        self.comboBox.setItemText(9, _translate("MainWindow", "Comprehension"))
        self.comboBox.setItemText(10, _translate("MainWindow", "Exceptions"))
        self.comboBox.setItemText(11, _translate("MainWindow", "Local and global scope"))
        self.comboBox.setItemText(12, _translate("MainWindow", "Closures"))
        self.comboBox.setItemText(13, _translate("MainWindow", "Short circuit evaluation"))
        self.generateButton.setText(_translate("MainWindow", "Generate Exercise"))
        self.outputLabel.setText(_translate("MainWindow", "Welcome!"))
        self.titleLabel.setText(_translate("MainWindow", self.comboBox.currentText()))

    def handle_combobox_change(self):
        self.titleLabel.setText(self.comboBox.currentText())
    
    def get_exercise(self):
        exercise_list = exercises[self.comboBox.currentText()]
